    ...
    <div className={styles.montage}>
      ...
      <div className={styles.montage_row}>
        ...
        <div className={styles.montage_image}>
          ...
          <span className={styles.montage_rowSpan}>تدوین تیزر تبلیغاتی نوشیدنی انرژی زا</span>
        </div>
        <div className={styles.montage_addBtn}>
          <span className={styles.montage_plusBtn}>
            <BsPlusCircle size={20} />
            افزودن اثر
          </span>
          <span className={styles.montage_moreDisplay}>
            نمایش <br />
            بیشتر...
          </span>
        </div>
